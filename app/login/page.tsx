    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-6 md:px-12">
        ...
        <div className="flex items-center gap-4">
          <Link href="/register" className="font-mono text-sm text-foreground/80 hover:text-foreground transition-colors">
            Register
          </Link>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="font-mono text-sm text-foreground/60">
              Sign in to your CloudPOS account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs text-foreground/60">Remember me</span>
              </label>
              <a href="#" className="font-mono text-xs text-foreground/60 hover:text-foreground transition-colors">
                Forgot password?
              </a>
            </div>
